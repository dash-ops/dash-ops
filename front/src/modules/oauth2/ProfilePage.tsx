                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      {Object.entries(permissions.permissions || {}).map(
                        ([plugin, pluginPerms]) => (
                          <div key={plugin} className="border rounded-lg p-3">
                            ...
                            <div className="space-y-2">
                              {Object.entries(pluginPerms).map(
                                ([feature, actions]) => (
            ...
            <CardContent>
              <div className="text-center py-6">
                <p className="text-muted-foreground text-sm mb-2">
                  OAuth2 configuration settings will be available here in future
                  updates.
                </p>
                <p className="text-muted-foreground text-sm">
                  This will include client ID management, scopes, and redirect
                  URL configurations.
                </p>
              </div>
            </CardContent>
