...
import { Building2, ChevronDown, LogOut, User, Settings, Users } from "lucide-react"
import { getUserData, getUserPermissions } from "../modules/oauth2/userResource"
import { cleanToken } from "../helpers/oauth"

function AppSidebar({ menus = [], oAuth2 }) {
                ...
                <div className="px-2 py-1">
                  ...
                  {permissions?.teams && permissions.teams.length > 0 ? (
                    permissions.teams.map((team, index) => (
                      <DropdownMenuItem key={team.slug || index} className="pl-6">
