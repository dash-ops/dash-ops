...
type AuthenticationService interface {
	...
	ValidateToken(ctx context.Context, token string) (*models.UserData, error)
...
type AuthorizationService interface {
	...
	CheckPermission(ctx context.Context, userData *models.UserData, requiredPermissions []string) (bool, error)

	// GetUserPermissions returns all permissions for a user
	GetUserPermissions(ctx context.Context, userData *models.UserData) ([]string, error)
}
